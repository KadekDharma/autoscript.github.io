...
## ⏩ Installation ⏪
> rm -f setup.sh && apt upgrade -y && apt update -y && apt install -y bzip2 gzip coreutils wget curl neofetch screen -y && wget -O setup.sh 'https://raw.githubusercontent.com/wildysheverando-project/autoscript.github.io/main/setup.sh' && chmod +x setup.sh && screen -S setup ./setup.sh
